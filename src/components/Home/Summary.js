    ...
    return (
        <div className='bg-slate-200 mx-auto px-12 pt-5 pb-5 text-center'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-5 '>
                <SummaryInfo cardTitle="Client Feedbacks" bgClass="bg-gradient-to-r from-secondary to-primary" img={clientC} description="550 +"></SummaryInfo>
                ...
                <SummaryInfo cardTitle="Business Countries" bgClass="bg-gradient-to-r from-secondary to-primary" img={clientF} description="Total Countries 350 business ongoing"></SummaryInfo>
            </div>
        </div>
